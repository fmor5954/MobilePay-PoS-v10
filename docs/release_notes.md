...
- Made the [Detecting MobilePay by notification service](detecting_mobilepay#notification_service) section more clear by adding the call ``GET /pointofsales/{posid}/checkin`` to the flow diagram
