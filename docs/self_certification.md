...
> NOTE: you will need to be subscribed to the PoS V10 for Self Certification API in the MobilePay developer portal, in order to start a self certification
