...
| `X-MobilePay-Merchant-VAT-Number` | Valid VAT number:<br>IsoCountryCode-VATNumber<br>Example: DK12345678 | Identifies the merchant the integrator is calling on behalf of |
